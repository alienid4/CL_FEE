...
BACKEND_BUILD = "v0.35.0 · 2026-07-21 16:20 · 診斷報告補上 wheel 標籤、pip 版本、Proxy 設定與 PyPI/GitHub 連通性，讓一趟 mail 就能判斷要送離線輪子還是叫他線上裝；並修好服務紀錄的混合編碼（Tee-Object 寫 UTF-16、表頭寫單位元組，報告讀出來每個字夾空白）"
