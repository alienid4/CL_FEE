...
BACKEND_BUILD = "v0.46.0 · 2026-07-27 · 系統編號改 12 碼無連字號(主管指定)：功能碼4(Case/Cont/Budg/Proj/Sign/Purc/Paym/Sett)+西元年4+流水號4，例 Cont20260001；同案各模組共用年+流水號、查 20260001 找到同案全部；搜尋比對與核銷編號同步改"
