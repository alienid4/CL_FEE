...
const BUILD_TAG = "v0.28.0 · 2026-07-21 09:58 · start.bat/start.sh 改名為 demo_start.bat/demo_start.sh，檔名直接說明它是 8025 展示模式而非正式入口；文件同步更新，download.bat 不再派送展示用檔案與文件";
(async () => {
