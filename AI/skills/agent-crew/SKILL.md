...
| --------- | ---------------------------------- | ----- | ------ | ------------------ |
| architect | `agent, read, search, todo`        | no    | yes    | default/strong     |
| coder     | `read, edit, search, execute`      | yes   | no     | strong coding model|
| reviewer  | `read, search, execute`            | no    | no     | careful/critical model |
| tester    | `read, search, execute`            | no    | no     | strong reasoning model |
